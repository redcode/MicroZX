...
#include <Z/formats/snapshot/machine/computer/ZX Spectrum/SIT.h>
...
static ZStatus test(ZSIT *object, zsize object_size)
	{
	if (object_size	!= sizeof(ZSIT)) return Z_ERROR_INVALID_SIZE;
